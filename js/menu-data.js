/* =====================================================
   فایل داده‌های نهایی منوی POTO CHEESE
   فقط برچسب «تند» نگه داشته شده است.
   ===================================================== */
...
const categories = [
  { id: "potatoes", labelFa: "پوتو", labelEn: "Poto", emoji: "🥔", icon: "images/icons/poto.png" },
  { id: "snacks", labelFa: "اسنک", labelEn: "Snacks", emoji: "🍟", icon: "images/icons/snack.png" },
  { id: "special-sauces", labelFa: "سس اسپشیال", labelEn: "Special Sauces", emoji: "🍯", icon: "images/icons/sauce.png" },
  { id: "hot-dips", labelFa: "دیپ هات", labelEn: "Hot Dips", emoji: "🫕", icon: "images/icons/dip.png" },
  { id: "drinks", labelFa: "نوشیدنی", labelEn: "Drinks", emoji: "🥤", icon: "images/icons/drink.png" }
];
